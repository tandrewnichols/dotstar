...
echo "  \[\033[1;30m\]4\[\033[0m\]. Run \[\033[0;32m\]defaults write com.apple.screencapture name "Screenshot"\[\033[0m\] and then \[\033[0;32m\]killall SystemUIServer\[\033[0m\] to make screenshots correct. Also disable thumbnails with Cmd-Shift-5."
