...
export DEV_DEPS="coffee-script grunt grunt-contrib-jshint grunt-mocha-test grunt-travis-matrix indeed jshint-stylish mocha mocha-given proxyquire sinon task-master grunt-contrib-watch grunt-open grunt-contrib-clean grunt-simple-istanbul"
export FE_DEPS="grunt-contrib-testem grunt-contrib-uglify grunt-contrib-copy expect.js grunt-browserify"
